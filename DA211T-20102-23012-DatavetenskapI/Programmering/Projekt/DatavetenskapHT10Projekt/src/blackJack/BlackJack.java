...
public class BlackJack extends JPanel
{
    ...
    public void setPortal(JPanel portalPanel)
    {
    ...
    public void exitGame()
    {
        ...
        CardLayout blah = (CardLayout)portalPanel.getLayout();
        blah.show(portalPanel, (String)"Index");
        //(CardLayout)portalPanel.getLayout().show(portalPanel, (String)"Index");
        //System.exit(0);
    }
